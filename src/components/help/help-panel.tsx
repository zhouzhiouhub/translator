    ...
    <PageContainer>
      ...
      <section className="rounded-2xl border border-border bg-card p-5 shadow-sm">
        ...
        <div className="mt-4 flex flex-wrap gap-2">
          <HelpLink href={`/${routeLocale}/settings/ai`}>{t("linkConfig")}</HelpLink>
          <HelpLink href={`/${routeLocale}`}>{t("linkTranslator")}</HelpLink>
          <HelpLink href={`/${routeLocale}/history`}>{t("linkHistory")}</HelpLink>
        </div>
      </section>
